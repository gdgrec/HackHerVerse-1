        ...
        <div className="max-w-4xl mx-auto section-container relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glassmorphism rounded-2xl p-6 text-center">
              ...
              <p className="text-pink-600 text-responsive-lg mb-2 font-[family-name:var(--font-sans)]">Professor, Computer Science</p>
              <p className="text-blue-800 text-responsive-lg font-[family-name:var(--font-sans)]">Faculty Advisor, WTM REC</p>
            </div>
            
            <div className="glassmorphism rounded-2xl p-6 text-center">
              <h4 className="text-responsive-2xl font-bold text-blue-700 mb-1 font-[family-name:var(--font-display)]">Dr. Rakesh Kumar</h4>
              <p className="text-pink-600 text-responsive-lg mb-2 font-[family-name:var(--font-sans)]">Associate Professor, IT Department</p>
              <p className="text-blue-800 text-responsive-lg font-[family-name:var(--font-sans)]">Technical Mentor, WTM REC</p>
            </div>
          </div>
        </div>
      </section>
